<?php
	...
	$sql_ins = "insert into t_service(nowtime,name,telephone,service,date,time,region,village,address,area,servicetrait,remark) values(
'$_POST[nowtime]','$_POST[name]','$_POST[telephone]','$_POST[service]','$_POST[date]','$_POST[time]','$_POST[region]','$_POST[village]','$_POST[address]','$_POST[area]','$_POST[servicetrait]','$_POST[remark]')";
