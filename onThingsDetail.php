<?php
	...
	$sql_sel = "select objectId,name,telephone,service,date,time,region,province,city,district,village,address,choseTrait,remark,status,createdBy,createdAt,updatedBy,updatedAt from DT_THINGS where status=1 and objectId='$_POST[objectId]'";
